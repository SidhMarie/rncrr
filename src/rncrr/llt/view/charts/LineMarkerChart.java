...
/**
 * Created by Sidh on 21.08.2015.
 */
public class LineMarkerChart<X,Y> extends LineChart<X,Y> {

    private ObservableList<Data<X, Y>> horizontalMarkers;
    private ObservableList<Data<X, Y>> verticalMarkers;

    public LineMarkerChart(Axis<X> xAxis, Axis<Y> yAxis) {
        super(xAxis, yAxis);
